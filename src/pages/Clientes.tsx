...
const Clientes = () => {
  ...
  const emptyForm: Cliente = { codigo: "", nome: "", cpfCnpj: "", telefone: "", email: "", endereco: "", cidade: "", uf: "", cep: "" };
  ...
  const filtered = items.filter((p) => p.nome.toLowerCase().includes(search.toLowerCase()) || p.cpfCnpj.includes(search) || p.codigo.includes(search));
    ...
    <div>
      <fieldset className="fieldset-retro">
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <input type="text" className="input-retro flex-1" placeholder="Pesquisar por nome, CPF/CNPJ ou código..." value={search} onChange={(e) => setSearch(e.target.value)} />
          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="bg-primary text-primary-foreground">
                ...
                <th className="text-left p-1 px-2 font-semibold border-r border-primary-foreground/30">CPF/CNPJ</th>
                ...
                <th className="text-left p-1 px-2 font-semibold border-r border-primary-foreground/30">UF</th>
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="window-frame w-[520px]">
            <div className="window-titlebar">{editIndex !== null ? "Editar Cliente" : "Novo Cliente"}</div>
            <div className="p-4">
              <fieldset className="fieldset-retro">
                ...
                <div className="grid grid-cols-[100px_1fr] gap-y-2 items-center text-[13px]">
                  ...
                  <input type="text" className="input-retro" placeholder="000.000.000-00" value={form.cpfCnpj} onChange={(e) => setForm({ ...form, cpfCnpj: e.target.value })} maxLength={18} />
